...
use Lyrasoft\Portfolio\Module\Admin\Portfolio\Form\GridForm;
...
class PortfolioListView implements ViewModelInterface
{
    ...
    {
        return $ordering === 'category.title ASC, portfolio.ordering ASC';
    }
    ...
    protected function prepareMetadata(AppContext $app, View $view): void
    {
        $view->getHtmlFrame()
            ->setTitle(
                $this->trans('unicorn.title.grid', title: '作品')
            );
    }
}
